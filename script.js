...
const moreNotes = [
  {
    name: "note 8",
    id: 8,
    createdAt: '2023-07-31T14:30:00',
    content: 'Write a new article on web development',
    category: 'Task',
    archived: false,
  },
  {
    name: "note 9",
    id: 9,
    createdAt: '2023-07-31T15:45:00',
    content: 'Plan the marketing campaign for the new product launch',
    category: 'Task',
    archived: false,
  },
];

const notesData = [...notes, ...moreNotes];
